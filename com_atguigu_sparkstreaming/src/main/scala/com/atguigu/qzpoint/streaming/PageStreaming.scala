...
/**
  * 页面转换率实时统计
  *
  * nohup spark-submit  --master yarn --deploy-mode client --driver-memory 1g --num-executors 5 --executor-cores 2 --executor-memory 2g --class com.atguigu.qzpoint.streaming.PageStreaming  --queue spark com_atguigu_sparkstreaming-1.0-SNAPSHOT-jar-with-dependencies.jar >1.txt>&1 &
  */
